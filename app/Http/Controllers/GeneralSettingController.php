...
class GeneralSettingController extends Controller
{
	...
	public function UpdateGenSetting(Request $request)
    {
       ...
       $data = GeneralSettings::whereId(1)->update([
           ...
           'newsletter_title' => $request->newsletter_title == '' ? $gnl->newsletter_title: $request->newsletter_title,
           'newsletter_sub_title' => $request->newsletter_sub_title == '' ? $gnl->newsletter_sub_title: $request->newsletter_sub_title,
           'about_video_link' => $request->about_video_link == '' ? $gnl->about_video_link: $request->about_video_link,
