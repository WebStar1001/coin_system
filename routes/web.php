...
Route::get('/', 'FrontendController@frontIndex');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
    ...
    Route::post('/bank/gateway', 'AdminCotroller@gatewayBankStore')->name('bank.gateway.store');
...
Route::group(['prefix' => '/', 'middleware' => 'auth:web'], function () {
    ...
    Route::post('/find-sto', 'HomeController@findSto')->name('find.sto');
