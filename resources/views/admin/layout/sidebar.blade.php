<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview @if(request()->path() == 'admin/time') is-expanded
                            ...
                            @endif">
            <a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-clone"></i><span class="app-menu__label"> STO Management</span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item @if(request()->path() == 'admin/plan') active @elseif(request()->path() == 'admin/plan/create') active @elseif(request()->route()->getName() == 'plan.edit') active @endif" href="{{route('plan.index')}}"><i class="icon fa fa-briefcase"></i>Manage STO</a></li>
            </ul>
        </li>
        ...
        <li class="treeview @if(request()->path() == 'admin/team') is-expanded
            ...
            <ul class="treeview-menu">
                ...
                <li><a class="treeview-item @if(request()->path() == 'admin/static') active @endif" href="{{route('static.index')}}"><i class="icon fa fa-adjust"></i>Manage Road Map</a></li>
