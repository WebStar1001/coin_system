...
@section('content')
    ...
    <div class="all-transation-area" style="margin-bottom: 120px; background-color: #fff;">
        <div class="container">
                            ...
                            <div class="card-body text-center">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" value="{{$prevcode}}" style="padding: 5px;" class="form-control input-lg" id="code" readonly>
                    ...
                    @else
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input type="text" name="key" value="{{$secret}}" style="padding: 5px;" class="form-control input-lg" id="code" readonly>
                                        <span class="input-group-addon btn btn-success" id="copybtn">@lang('Copy')</span>
                                    </div>
                                </div>
                                <div class="form-group">
